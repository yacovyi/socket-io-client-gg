...
const workspaceItemAddedChannel = "workspaceItemAddedChannel";
const channels = workspaceItemAddedChannel;
let i = 0;
(async () => {
    try {
        ...
        socket.on(workspaceItemAddedChannel, function(data){
            console.log(new Date().toISOString(), 'data', data);
            i++;
            console.log(`Messages received: ${i} ${workspaceItemAddedChannel}`);
        });
